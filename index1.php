   ...
   //PARA NACHO
     if ($perm=='ROL_DWH_PROCESO_NACHO') {  ?>
        ...
        <li><a href="javascript:ajax_get('contenido','parte_diario/comparaentreestados.php','');">COMPARATIVO DE RESULTADOS</a></li>
           ...
           <li><a href="javascript:ajax_get('contenido','importacion/importacion.php','');">IMPORTACION</a></li>
           </ul>
        <!-- FIN REPORTES PARA NACHO-->    
       
       <!-- DATAWAREHOUSE PARA NACHO-->
          <li><a href="javascript:void(0)" class="qmparent"><strong>DATAWAREHOUSE</strong></a></li>
          <ul>
          <li><a href="javascript:ajax_get('contenido','importacion/nacho.php','');">NACHO-PROCESO</a></li>
            <!--<li><a href="javascript:ajax_get('contenido','reportes/busqueda_reportes.php','');">REPORTE DIARIO</a></li>
            <li><a href="javascript:ajax_get('contenido','exportacion/example.php','');">EXPORTACION</a></li>-->
          </ul>
         ...
         if ($perm=='ROL_CASINO_PAR_DIARIO_OPERADOR') {  ?>
          ...
          <ul>
<!--              <li><a href="#"><strong>ELIJA JUEGO</strong></a></li>     -->
...
<?php } //fin if rol?>
	  ...
	  <?php   if ($perm=='ROL_CASINO_PAR_DIARIO_ADMIN') {  ?>
        ...
        <li><a href="javascript:ajax_get('contenido','parte_diario/comparaentreestados.php','');">COMPARATIVO DE RESULTADOS</a></li>
         ...
         <?php   if ($perm=='ROL_DWH_PROCESO_NACHO') {  ?>
         
          <li><a href="javascript:void(0)" class="qmparent"><strong>DATAWAREHOUSE</strong></a>
          <ul>
                   <li><a href="javascript:ajax_get('contenido','importacion/nacho.php','');">NACHO-PROCESO</a></li>
      ...
      <!--    <?php /* if ($_SESSION['id_area']==82 || $_SESSION['id_area']==83) {  ?>
 		  <li><a href="javascript:void(0)" class="qmparent"><strong>Cambiar de Casino</strong></a>
  <?php       if ($_SESSION['id_area']=='82') { ?>   
              <ul> <li><a href="index.php?id_area=<?php echo 83 ?>" >  A CASINO CARLOS PAZ ANEXO </a></li></ul>
<?php  } ?>
  <?php       if ($_SESSION['id_area']=='83') { ?>   
                <ul> <li><a href="index.php?id_area=<?php echo 82 ?>">  A CASINO CARLOS PAZ  </a></li></ul>
<?php  } ?>
  <?php  } */?>-->
 	 <li><a href="javascript:history.back()" class="qmparent"><strong>Salir</strong></a></li>
         </li> </td>
